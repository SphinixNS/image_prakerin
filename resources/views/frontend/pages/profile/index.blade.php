...
@section('content')
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y container-profile">
            <div class="row">
                <div class="col-md-12">
                                ...
                                <div class="card-body">
                                    <form id="formAccountSettings" method="POST" onsubmit="return false">
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label" for="parentPhoneNumber">Nomor Telepon Orang Tua / Wali</label>
                                                <div class="input-group input-group-merge">
                                                    <span class="input-group-text">ID (+62)</span>
                                    ...
                                    <form id="formChangePassword" onsubmit="return false">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control" id="newPassword"
                                                name="newPassword" placeholder="Masukkan kata sandi baru" required />
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control" id="confirmNewPassword"
                                                name="confirmNewPassword" placeholder="Konfirmasi kata sandi baru"
                                                required />
                                        </div>
