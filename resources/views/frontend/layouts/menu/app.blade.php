...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/menu/assets/vendor/css/core.css') }}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('frontend/menu/assets/vendor/css/theme-default.css') }}" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="{{ asset('frontend/menu/assets/css/menu.css') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/menu/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}" />
