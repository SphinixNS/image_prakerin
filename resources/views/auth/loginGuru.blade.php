        ...
        <div class="login-box">
            <div class="login-left">
                ...
                <form action="/auth" method="POST">
                    ...
                    <button type="submit" class="login-btn-guru">Login</button>
                    <a href="/" class="main-page-btn-guru">Ke Halaman Utama</a>
                </form>
            </div>
            <div class="login-right">
                <img src="{{ asset('frontend/img/guru.jpg') }}" alt="Right Image">
            </div>
        </div>
    </div>
