                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">Data Konsentrasi</h5>
                            <a href="{{ route('admin.konsentrasi.create') }}"> <button type="button"
                                    class="btn btn-primary">Add Data</button></a>
                        </div>
                        <div class="card-body">

                            <table class="table" id="table-konsentrasi">
                                <thead>
                                    <tr>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Pastikan tabel HTML dengan ID 'table-konsentrasi' sudah ada di DOM
            $('#table-konsentrasi').DataTable({
                 ...
                 <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li><a class="dropdown-item"
                               href="/admin/konsentrasi/edit/${id}"">Edit</a>
                            </li>
                          </ul>
                        </div>
                `
            ...
            $.ajax({
                url: "{{ route('admin.konsentrasi.konsentrasi') }}",
                method: "GET",
                success: function(response) {
                    // Update data setelah respon Ajax diterima
                    $('#table-konsentrasi').DataTable().clear().rows.add(response).draw();
                }
            });
        });
    </script>
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: 'konsentrasi/delete/' + id, // Sesuaikan dengan route Anda
                        type: 'GET',
                        success: function(response) {
                            Swal.fire(
                                'Terhapus!',
