                                        ...
                                        <tr>
                                            <td colspan="3" class="p-0">
                                                <div class="map-container mb-2 mt-2 mx-2">
                                                    <iframe src="{{ $data->lokasi }}" frameborder="0" allowfullscreen=""
                                                        ...
                                                        <div class="dropdown"
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1"
                                                                ...
                                                                <li><a class="dropdown-item"
                                                                        href="{{ route('admin.pemetaan.terima', $siswa->id) }}">Terima</a>
                                                                </li>
                                                                <li><a class="dropdown-item"
                                                                        href="{{ route('admin.pemetaan.tolak', $siswa->id) }}">Tolak</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                        ...
                                        <table class="table ">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td>
                                                        <a href="{{ route('admin.pembimbing.detail', $jurusan->pembimbing->pembimbing->id) }}"
                                                            style="text-decoration: none; color: inherit;">
                                                            {{ $jurusan->pembimbing->pembimbing->nama }}
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
