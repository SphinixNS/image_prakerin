                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.jurusan.create') }}"> <button type="button"
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Pastikan tabel HTML dengan ID 'table-jurusan' sudah ada di DOM
                 ...
                 <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li><a class="dropdown-item"
                               href="/admin/jurusan/edit/${id}"">Edit</a>
                            </li>
                          </ul>
                        </div>
                `
            ...
            $.ajax({
                url: "{{ route('admin.jurusan.jurusan') }}",
                method: "GET",
                success: function(response) {
                    // Update data setelah respon Ajax diterima
                    $('#table-jurusan').DataTable().clear().rows.add(response).draw();
                }
            });
        });
    </script>
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: 'jurusan/delete/' + id, // Sesuaikan dengan route Anda
                        type: 'GET',
                        success: function(response) {
                            Swal.fire(
                                'Terhapus!',
